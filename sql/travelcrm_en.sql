...
--
-- Name: appointment_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.appointment_id_seq OWNER TO mazvv;

--
-- Name: appointment_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: cashflow_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.cashflow_id_seq OWNER TO mazvv;

--
-- Name: cashflow_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: contract_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.contract_id_seq OWNER TO mazvv;

--
-- Name: contract_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: email_campaign; Type: TABLE; Schema: company; Owner: mazvv; Tablespace: 
--
...
ALTER TABLE company.email_campaign OWNER TO mazvv;

--
-- Name: email_campaign_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.email_campaign_id_seq OWNER TO mazvv;

--
-- Name: email_campaign_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: navigation_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.navigation_id_seq OWNER TO mazvv;

--
-- Name: navigation_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: permision_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.permision_id_seq OWNER TO mazvv;

--
-- Name: permision_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: position_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.position_id_seq OWNER TO mazvv;

--
-- Name: position_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: structure_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.structure_id_seq OWNER TO mazvv;

--
-- Name: structure_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: supplier_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.supplier_id_seq OWNER TO mazvv;

--
-- Name: supplier_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
--
-- Name: tour_id_seq; Type: SEQUENCE; Schema: company; Owner: mazvv
--
...
ALTER TABLE company.tour_id_seq OWNER TO mazvv;

--
-- Name: tour_id_seq; Type: SEQUENCE OWNED BY; Schema: company; Owner: mazvv
--
...
SELECT pg_catalog.setval('accomodation_id_seq', 1, false);
...
3	1439	56	1	Main Cash Account	cash payment	0	\N
4	1507	54	1	Main Cash EUR Account	Main Cash EUR Account	0	\N
2	1438	56	0	Main Bank Account	displa text	0	\N
\.
...
3	1432	\N	Taxes	0	0	\N
4	1608	\N	Operating charges	0	0	\N
5	1609	\N	Internal cash flow	0	0	\N
6	1769	\N	Profit distribution	0	0	\N
7	1780	2	Rent	0	0	\N
8	1873	2	POF	0	0	\N
9	1898	2	Communication	0	0	\N
10	2199	2	Marketing, Sales	0	0	\N
11	2246	2	Software	0	0	Sales of any type of tickets
13	2277	2	Other operating	0	0	\N
1	1426	3	Income Tax	0	0	\N
14	2389	3	VAT	0	0	\N
15	2390	3	Other taxes, fees	0	0	\N
17	2392	4	Return to the buyer	0	0	\N
18	2393	4	Payment of the tour operator	0	0	\N
19	2394	4	Return the tour operator	0	0	\N
20	2395	4	Other operating income	0	0	\N
21	2396	4	Other operating expenses	0	0	\N
22	2397	5	The money from bank to bank	0	0	\N
23	2398	5	The money from the cash to the account	0	0	\N
24	2399	5	Money from the account in cash	0	0	\N
25	2400	5	Conversion	0	0	\N
26	2401	6	Acquisition of fixed assets	0	0	\N
27	2402	6	The withdrawal of capital	0	0	\N
28	2403	7	Rental fee	0	0	\N
29	2404	7	Utility payments	0	0	\N
30	2405	8	POF payable	0	0	\N
31	2406	8	PIT	0	0	\N
32	2407	8	ERUs	0	0	\N
33	2408	8	Bonuses (bonus)	0	0	\N
34	2409	9	Telephone landline	0	0	\N
35	2410	9	Mobile Phones	0	0	\N
36	2411	9	Internet	0	0	\N
37	2412	9	Other	0	0	\N
38	2413	10	Outdoor advertising	0	0	\N
39	2414	10	Advertising in print media	0	0	\N
40	2415	10	Advertising on TV, radio	0	0	\N
41	2416	10	Promotions and presentations	0	0	\N
42	2417	10	Exhibitions	0	0	\N
43	2418	10	Advertising on the Internet	0	0	\N
44	2419	10	 Website Promotion	0	0	\N
45	2420	10	Mailing lists	0	0	\N
46	2421	10	Other marketing	0	0	\N
47	2422	11	The costs for the modernization of the local software	0	0	\N
48	2423	11	The cost of upgrading the website	0	0	\N
49	2424	12	Bank charges	0	0	\N
50	2425	12	Other cash and settlement services	0	0	\N
51	2426	13	Office supplies, office software	0	0	\N
52	2427	13	Representation	0	0	\N
53	2428	13	Staff Missions	0	0	\N
54	2429	13	Postage, courier services	0	0	\N
55	2430	13	Minor repairs of machinery	0	0	\N
56	2431	13	Purchase low-value goods	0	0	\N
57	2432	13	Other (not included in any of the articles)	0	0	\N
2	1431	\N	Administrative expensive	2	0	Group of items
12	2269	2	Cash and Settlement Services	2	0	\N
16	2391	4	Payment by the buyer	1	0	\N
\.
...
SELECT pg_catalog.setval('account_item_id_seq', 1, false);
...
SELECT pg_catalog.setval('advsource_id_seq', 1, false);
...
6	892	2014-02-22	7	5	4500.00	54
8	1542	2014-03-01	2	4	6500.00	54
12	2658	2015-05-01	7	6	12000.00	56
\.


--
-- Name: appointment_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--
...
1	1009	Alexandro	Riak		Sales Manager	0	\N
6	1560	Ivan	Gonchar		Account Manager	0	\N
5	1553	Sergey	Vlasov		Main account manager	0	\N
...
SELECT pg_catalog.setval('bperson_id_seq', 1, false);
...
216	19	\N	27	500.00	\N	2015-06-14
250	\N	22	16	380.00	\N	2015-06-14
251	22	18	\N	272.00	20.65	2015-06-14
252	\N	21	16	35500.00	\N	2015-06-14
253	21	19	\N	35500.00	2356.80	2015-06-14
254	\N	21	16	5000.00	\N	2015-06-14
255	21	19	\N	5000.00	2356.80	2015-06-14
256	\N	22	16	1400.73	20.65	2015-06-13
257	22	18	\N	1292.73	\N	2015-06-13
258	23	\N	18	15000.00	\N	2015-06-14
259	22	\N	17	108.00	\N	2015-06-14
260	\N	24	16	25000.00	6856.68	2015-07-22
261	24	20	\N	25000.00	\N	2015-07-22
\.


--
-- Name: cashflow_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--

SELECT pg_catalog.setval('cashflow_id_seq', 1, false);
...
1	1970	56	TravelCmpany, Inc	vitalii.mazur@gmail.com	{"locale": "en", "timezone": "Europe/Kiev"}
\.
...
27	1193	0	+380681983869	0	\N
29	1195	0	+380681983869	0	\N
30	1201	0	+380681983869	0	\N
32	1204	0	+380681983869	0	\N
36	1244	0	+380681983869	0	\N
37	1257	0	+380681983869	0	\N
39	1259	0	+380681983869	0	\N
41	1263	0	+380682523645	0	\N
44	1282	0	+380675625353	0	\N
45	1285	0	+380502355565	0	\N
47	1371	0	+380673566789	0	\N
48	1373	0	+380502314567	0	\N
51	1387	0	+380502232233	0	\N
52	1404	0	+380502354235	0	\N
53	1464	0	+380503435512	0	\N
54	1516	0	+380976543565	0	\N
55	1517	0	+380675643623	0	\N
58	1543	0	+380681983800	0	\N
61	1551	0	+380681234567	0	\N
64	1561	0	+380953434358	0	\N
67	1581	0	+380672568976	0	\N
68	1591	0	+380672346534	0	\N
69	1610	0	+380500567765	0	\N
71	1620	0	+380503435436	0	\N
73	1624	0	+380975642876	0	\N
74	1640	0	+380665638900	0	\N
76	1650	0	+380502235686	0	\N
77	1927	0	+380674523123	0	\N
79	2013	0	+380923435643	0	\N
80	2018	0	+380505674534	0	\N
81	2050	0	+380671238943	0	\N
28	1194	1	asdasd@mail.com	0	\N
35	1243	1	vitalii.mazur@gmail.com	0	\N
38	1258	1	vitalii.mazur@gmail.com	0	\N
40	1260	1	vitalii.mazur@gmail.com	0	\N
42	1264	1	a.koff@gmail.com	0	\N
46	1304	1	n.voevoda@gmail.com	0	\N
57	1519	1	ravak@myemail.com	0	\N
60	1545	1	info@travelcrm.org.ua	0	\N
63	1559	1	i_gonchar@i-tele.com	0	\N
65	1562	1	mega_tkach@ukr.net	0	\N
70	1611	1	artyuh87@gmail.com	0	\N
72	1621	1	grach18@ukr.net	0	\N
75	1641	1	karpuha1990@ukr.net	0	\N
78	1956	1	vitalii.mazur@gmail.com	0	\N
49	1379	2	travelcrm	0	\N
56	1518	2	ravak_skype	0	\N
59	1544	2	dorianyats	0	\N
62	1552	2	serge_vlasov	0	\N
50	1380	0	+380682345688	0	\N
82	2089	0	+380676775643	0	\N
83	2095	1	nikolay1987@mail.ru	0	\N
66	1577	2	AnnaNews	1	
84	2307	0	+380672334345	0	
85	2308	0	+380503435676	1	
86	2327	0	+380674252212	0	
87	2338	0	+380678521452	0	
88	2366	0	+380502356543	0	
89	2493	1	mazira@online.ua	0	
90	2550	0	+380661234567	1	
91	2585	0	+380500126753	0	New phone
92	2586	1	grisha_1972@mail.ru	0	
93	2587	2	grishutka_super	0	
94	2594	0	+380973498675	0	
95	2659	2	valik_gopko	0	
96	2666	0	+380673508989	0	
97	2676	0	+380504538765	0	
\.
...
48	2210	1234/56	2015-05-09	0	Test contract
49	2213	12345/67	2015-05-09	0	Test agent contract for supplier
50	2215	12/34	2014-01-10	1	First contract
51	2489	19/06	2015-06-23	0	
52	2490	19/06	2015-06-23	0	
54	2506	36542-89.77	2015-06-01	0	
55	2511	678/90	2015-06-01	0	
53	2491	19/06/15	2015-06-01	0	
56	2540	0987-97	2015-05-01	0	Contract with teztour
57	2545	TUI-09-15	2015-06-01	0	
58	2695	#08-01	2015-08-01	0	
59	2699	#07-01	2015-07-01	0	
\.
...
--
-- Name: contract_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--
...
SELECT pg_catalog.setval('crosspayment_id_seq', 1, false);
...
19	2281	57	87	2015-05-15	23.00
20	2289	57	102	2015-05-17	22.70
21	2290	57	102	2015-04-29	23.05
22	2319	54	87	2015-06-01	24.20
23	2334	57	93	2015-06-02	21.50
24	2335	54	93	2015-06-02	23.65
25	2336	57	100	2015-06-02	21.66
26	2337	54	100	2015-06-02	23.70
27	2383	54	102	2015-06-06	24.30
28	2384	54	92	2015-06-06	24.25
29	2385	57	92	2015-06-06	21.50
30	2714	54	101	2015-07-22	26.37
31	2723	57	101	2015-07-22	23.98
\.
...
4	786	\N	Oleg	Pogorelov		\N	\N
8	893	\N	Oleg	Mazur	V.	\N	\N
9	1040	\N	Halyna	Sereda		\N	\N
10	1041	\N	Andrey	Shabanov		\N	\N
11	1042	\N	Dymitrii	Veremeychuk		\N	\N
13	1044	\N	Alexandra	Koff	\N	\N	\N
14	1045	\N	Dima	Shkreba	\N	\N	2013-04-30
15	1046	\N	Viktoriia	Lastovets	\N	\N	2014-04-29
12	1043	\N	Denis	Yurin	\N	12	2014-04-01
30	2053	\N	Igor	Mazur	\N	\N	\N
31	2477	\N	Alina	Kabaeva	\N	344	2015-06-23
2	784	7	John	Doe	\N	\N	\N
7	885	18	Irina	Mazur	V.	\N	2015-07-01
\.
...
SELECT pg_catalog.setval('foodcat_id_seq', 1, false);
...
10	1292	5	16	Hotel View Novi Vindolski
11	1320	5	17	PGS Kiris Resort
12	1322	5	18	Justiniano Club Park Conti
13	1323	5	17	PGS World Palace
14	1324	5	18	Concordia Celes Hotel
15	1325	5	17	Akka Alinda Hotel
16	1327	5	19	Grand Haber Hotel
17	1330	5	20	Belconti Resort
18	1331	3	19	Asdem Park
19	1334	4	21	Saphir
20	1335	4	18	Justiniano Club Alanya
21	1338	6	22	Euphoria Palm Beach
22	1342	4	23	Avlida
23	1346	3	24	Calypso
24	1349	4	25	Citta Del Mare
25	1350	4	24	Villa Adriatica
26	1354	4	26	Aldemar Cretan Village
27	1357	4	27	Estival Park Salou Hotel
28	1358	3	27	Playa Park
29	1360	4	28	Best Negresco
30	1362	4	29	Oasis Park & SPA
31	1364	5	30	The Desert Rose Resort
32	1367	4	31	Rehana Sharm Resort
33	1386	4	32	Fantasia
34	1470	5	21	Villa Augusto
35	1590	5	36	Lindos Blue
36	1649	5	37	Sezz Saint-Tropez
38	2111	5	36	Spirit of the Knights Boutique
39	2375	5	39	Radisson Blu Resort & Spa
40	2675	4	40	Frangiorgio Hotel Apartments
\.
...
SELECT pg_catalog.setval('hotelcat_id_seq', 1, false);
...
65	2457	31	16	380.00	2015-06-14	\N
66	2458	30	16	35500.00	2015-06-14	\N
67	2459	30	16	5000.00	2015-06-14	\N
60	2451	31	16	1400.73	2015-06-13	\N
68	2737	32	16	25000.00	2015-07-22	\N
\.
...
SELECT pg_catalog.setval('income_id_seq', 1, false);
...
32	2015-07-22	2015-07-25	2729	10	2	\N
30	2015-06-06	2015-06-09	2388	9	3	\N
31	2015-06-13	2015-06-16	2450	7	4	\N
\.
...
29	30	43	7290.00	1215.00	0.00	The issues for visas
32	32	44	41245.60	6736.78	824.91	Tour booking service
33	32	45	719.40	119.90	0.00	The issues for visas
30	30	42	57090.00	703.93	2627.25	Tour booking service
31	31	39	1672.73	33.45	0.00	Tour booking service
\.
...
SELECT pg_catalog.setval('lead_item_id_seq', 1, false);
...
SELECT pg_catalog.setval('lead_offer_id_seq', 1, false);
...
1	1091	12	Kestel
3	1093	7	Airport Julyany (Kiev)
5	1097	13	Simferopol
6	1102	15	Munich
14	1287	7	Kiev
15	1289	7	Borispol Airport
16	1291	23	Opatiya
17	1319	10	Kirish
18	1321	12	Okurcalar
19	1326	10	Kemer
20	1329	24	Belek
21	1333	25	Konacli
22	1337	26	Kizilagac
23	1341	27	Paphos
24	1345	28	Marino Centro
25	1348	29	Terrasini
26	1353	30	Hersonissos
27	1356	31	La Pineda
28	1359	31	Salou
29	1361	18	Lorett de Marr
30	1363	9	Hurgada
31	1366	32	Nabk Bey
32	1385	33	Svalyava
33	1417	34	Dnepropetrovsk
34	1468	22	Lviv
35	1588	35	Diagoras Airport
36	1589	35	Rhodos
37	1648	36	Saint-Tropez
39	2374	38	Orashac
40	2674	39	Larnaka
\.
...
41	1079	5	\N	Home	/	\N	fa fa-home	f	1
47	1253	5	\N	For Test	/	\N	fa fa-credit-card	f	2
...
163	1953	4	26	Email Campaigns	/emails_campaigns	\N	\N	t	2
...
182	2602	6	\N	Home	/	\N	fa fa-home	f	1
183	2603	6	\N	Sales	/	\N	fa fa-legal	f	2
184	2604	6	\N	Clientage	/	\N	fa fa-briefcase	f	3
185	2605	6	\N	Marketing	/	\N	fa fa-bullhorn	f	4
188	2608	6	\N	Directories	/	\N	fa fa-book	f	8
192	2612	6	229	Hotels List	/hotels	\N	\N	f	5
193	2613	6	228	Locations	/locations	\N	\N	f	3
197	2617	6	183	Invoices	/invoices	tab_open	\N	t	5
211	2631	6	184	Persons	/persons	\N	\N	f	1
212	2632	6	228	Countries	/countries	\N	\N	f	4
213	2633	6	228	Regions	/regions	\N	\N	f	3
214	2634	6	185	Advertising Sources	/advsources	\N	\N	f	1
215	2635	6	229	Hotels Categories	/hotelcats	\N	\N	f	6
216	2636	6	229	Rooms Categories	/roomcats	\N	\N	f	7
217	2637	6	229	Accomodations	/accomodations	tab_open	\N	f	10
218	2638	6	229	Food Categories	/foodcats	\N	\N	f	9
222	2642	6	188	Business Persons	/bpersons	tab_open	\N	f	4
223	2643	6	188	Suppliers	/suppliers	tab_open	\N	f	1
226	2646	6	183	Leads	/leads	tab_open	\N	f	2
227	2647	6	183	Orders	/orders	tab_open	\N	f	4
228	2648	6	188	Geography	/	\N	\N	f	10
229	2649	6	188	Hotels	/	\N	\N	t	9
230	2650	6	188	Transfers	/transfers	tab_open	\N	t	5
231	2651	6	188	Transport	/transports	tab_open	\N	f	6
232	2652	6	188	Suppliers Types	/suppliers_types	tab_open	\N	f	3
233	2653	6	188	Contracts	/contracts	tab_open	\N	f	2
234	2654	6	188	Ticket Class	/tickets_classes	tab_open	\N	f	7
235	2655	6	188	Persons Categories	/persons_categories	tab_open	\N	f	8
\.


--
-- Name: navigation_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--

SELECT pg_catalog.setval('navigation_id_seq', 1, false);
...
3	1945	A reminder of the task #42	Do not forget about task!	\N	2014-12-14 19:51:00.013635+02
4	1946	A reminder of the task #42	Do not forget about task!	\N	2014-12-14 20:31:00.012771+02
5	1947	A reminder of the task #40	Do not forget about task!	\N	2014-12-14 20:32:00.061386+02
6	1948	A reminder of the task #42	Do not forget about task!	\N	2014-12-14 20:34:00.011181+02
7	1949	A reminder of the task #42	Do not forget about task!	\N	2014-12-14 20:35:00.011903+02
8	1950	A reminder of the task #42	Do not forget about task!	\N	2014-12-14 20:38:00.01699+02
9	1959	A reminder of the task #44	Do not forget about task!	\N	2014-12-21 19:21:00.016784+02
10	1961	Task: #44	Test new scheduler realization	\N	2014-12-21 19:44:00.016315+02
11	1963	Task: Test	Test	\N	2014-12-24 21:33:00.014126+02
12	1965	Task: For testing	For testing	\N	2014-12-25 21:06:00.013657+02
13	1972	Task: Check Payments	Check Payments	\N	2015-01-04 12:46:00.019127+02
14	1973	Task: Check Payments	Check Payments	\N	2015-01-04 14:06:00.016859+02
15	1984	Task: Test	Test	\N	2015-01-13 17:01:00.018967+02
16	1986	Task: Test 2	Test 2	\N	2015-01-13 17:04:00.011637+02
17	2010	Task: I decided to try to follow the postgres approach as directly as possible and came up with the following migration.	I decided to try to follow the postgres approach as directly as possible and came up with the following migration.	\N	2015-01-21 21:45:00.013037+02
18	2064	Task: Revert status after testing	Revert status after testing	\N	2015-03-08 18:42:00.01327+02
19	2067	Task: Notifications testing #2	Notifications testing #2	\N	2015-03-09 17:17:00.020674+02
20	2069	Task: Test Notification resource link	Test Notification resource link	\N	2015-03-09 19:29:00.018282+02
21	2076	Task: Call about discounts	Call about discounts	\N	2015-03-21 17:10:00.014771+02
22	2133	Task: Task For Lastovec	Task For Lastovec	\N	2015-04-22 15:40:00.007831+03
23	2198	Task: Check reminder	Check reminder	\N	2015-05-03 13:35:00.039271+03
24	2304	Task: Call about offer	Call about offer	\N	2015-05-24 17:20:00.01303+03
25	2592	Task: JEasyui 1.4.3 migration	JEasyui 1.4.3 migration	\N	2015-07-19 23:55:00.094469+03
26	2672	Task: Call to customer!	Call to customer!	\N	2015-07-22 11:55:00.063723+03
27	2731	Task: Check invoice	Check invoice	\N	2015-07-22 15:20:00.039585+03
\.
...
4	2015-05-10	2275	17	\N	4	0	\N
3	2015-05-10	2267	43	\N	5	0	\N
2	2015-05-10	2264	44	\N	6	0	\N
5	2015-04-29	2280	42	\N	1	0	Test description
6	2015-05-16	2284	36	\N	2	0	\N
9	2015-06-06	2382	53	5	6	1	\N
8	2015-06-02	2345	50	4	2	1	\N
10	2015-07-22	2690	66	16	2	1	\N
7	2015-05-26	2317	48	3	4	3	For Lead testing
\.
...
28	2254	\N	7	57	97	420.00	0.00	0.00	0	\N	\N
29	2256	\N	7	57	97	420.00	0.00	0.00	0	\N	\N
30	2258	\N	7	57	97	420.00	0.00	0.00	0	\N	\N
34	2273	4	4	57	102	150.00	0.00	0.00	1	2015-05-10	\N
33	2265	3	5	57	94	2400.00	0.00	0.00	0	\N	\N
31	2260	2	7	57	97	422.00	0.00	0.00	0	\N	\N
32	2262	2	7	57	97	387.00	0.00	0.00	0	\N	\N
37	2285	\N	5	57	87	2780.00	0.00	0.00	1	2015-05-16	\N
38	2287	\N	7	54	97	640.00	0.00	0.00	2	2015-05-16	\N
36	2282	6	5	57	87	3201.00	0.00	2.00	0	2015-05-16	\N
35	2278	5	1	57	102	40.00	0.00	0.00	1	2015-05-10	passport had been received by customer
40	2341	8	5	57	93	3300.00	0.00	3.00	1	2015-06-02	\N
43	2379	9	4	54	102	300.00	0.00	0.00	1	2015-06-06	#678975-HJYT
42	2377	9	5	56	92	57090.00	1200.00	2.50	1	2015-06-06	#5677912TY
39	2315	7	5	57	87	1760.00	0.00	0.00	1	2015-05-26	#878qweiu
41	2343	8	4	54	100	130.00	0.00	2.00	2	2015-06-20	#6509-9
44	2686	10	5	57	101	1720.00	0.00	2.00	1	2015-07-22	BOOKING #: 1239642
45	2688	10	4	57	101	30.00	0.00	0.00	1	2015-07-22	succesfully confirmed
\.
...
13	2014-11-18	1903	3	10	8200.00	\N
16	2014-11-23	1915	6	12	15000.00	\N
23	2015-06-14	2467	18	23	15000.00	\N
21	2015-06-14	2463	17	22	108.00	Test for outgoing cashflows
\.
...
1	1199	14	0	231654	\N	\N
2	1200	14	0	132456	\N	\N
4	1205	12	0	1234564	\N	\N
5	1206	14	0	Svxzvxz	\N	xzcvxzcv
14	1584	3	0	RT678123	2015-08-21	Foreign Passport
15	1592	3	0	TY67342	2015-08-28	\N
17	1613	3	0	ER781263	\N	\N
21	1643	3	0	RT7892634	2017-07-19	\N
22	1651	3	0	RT632453	2019-08-16	\N
25	2019	9	0	TY78534	2018-06-06	\N
6	1261	3	1	НК028057	\N	\N
7	1265	3	1	HJ123456	\N	new passport
9	1376	3	1	HK123456	\N	\N
10	1381	3	1	HK12345	\N	\N
11	1406	3	1	PO123456	\N	\N
12	1467	3	1	TY3456	2016-04-10	\N
13	1582	3	1	YU78932	\N	Ukrainian citizen passport
16	1612	3	1	IO98676	\N	\N
18	1622	3	1	НК089564	\N	\N
19	1625	3	1	RE6712346	\N	\N
20	1642	3	1	HJ789665	\N	\N
23	1925	3	1	RTY	\N	\N
24	2014	3	1	HH67187	\N	\N
8	1286	3	1	РМ12345	2015-06-19	from Kiev region
26	2588	3	0	TT6785412	\N	\N
27	2589	3	1	HGTR789123	2015-07-31	\N
28	2677	3	1	TY56241	2018-02-07	\N
29	2680	3	0	YT76811	\N	\N
30	2681	3	1	RT61253	\N	\N
31	2683	3	0	YU678251	\N	\N
32	2685	3	1	TY65142	2018-04-06	\N
\.
...
53	2	5	{view,add,edit,delete}	all	\N
54	1	5	{view}	all	\N
...
68	1	7	{view}	all	\N
69	2	7	{view,add,edit,delete}	structure	5
...
85	65	8	{view,add,edit,delete}	all	\N
86	61	8	{view,add,edit,delete}	all	\N
87	59	8	{view,add,edit,delete}	all	\N
88	55	8	{view,add,edit,delete}	all	\N
89	41	8	{view,add,edit,delete}	all	\N
90	67	8	{view,add,edit,delete}	all	\N
91	69	8	{view,add,edit,delete}	all	\N
92	39	8	{view,add,edit,delete}	all	\N
93	70	8	{view,add,edit,delete}	all	\N
94	71	8	{view,add,edit,delete}	all	\N
95	72	8	{view,add,edit,delete}	all	\N
96	73	8	{view,add,edit,delete}	all	\N
97	74	8	{view,add,edit,delete}	all	\N
98	75	8	{view,add,edit,delete}	all	\N
99	78	8	{view,add,edit,delete}	all	\N
100	79	8	{view,add,edit,delete}	all	\N
101	47	8	{view,add,edit,delete}	all	\N
102	83	8	{view,add,edit,delete}	all	\N
103	84	8	{view,add,edit,delete}	all	\N
104	86	8	{view,add,edit,delete}	all	\N
105	87	8	{view,add,edit,delete}	all	\N
106	89	8	{view,add,edit,delete}	all	\N
107	90	8	{view,add,edit,delete}	all	\N
108	91	8	{view,add,edit,delete}	all	\N
109	1	8	{view}	all	\N
110	93	8	{view,add,edit,delete}	all	\N
111	101	8	{view,add,edit,delete}	all	\N
112	2	8	{view,add,edit,delete}	all	\N
113	102	8	{view,add,edit,delete}	all	\N
114	104	8	{view,add,edit,delete}	all	\N
115	105	8	{view,add,edit,delete}	all	\N
116	103	8	{view,add,edit,delete}	all	\N
117	106	8	{view,add,edit,delete}	all	\N
118	107	8	{view,add,edit,delete}	all	\N
120	110	8	{view,add,edit,delete}	all	\N
121	111	8	{view,add,edit,delete}	all	\N
123	12	8	{view,add,edit,delete,settings}	all	\N
...
135	124	4	{view,add,edit,delete}	all	\N
...
233	41	6	{view,add,edit,delete}	all	\N
234	67	6	{view,add,edit,delete}	all	\N
236	39	6	{view,add,edit,delete}	all	\N
237	70	6	{view,add,edit,delete}	all	\N
238	71	6	{view,add,edit,delete}	all	\N
239	72	6	{view,add,edit,delete}	all	\N
240	73	6	{view,add,edit,delete}	all	\N
241	74	6	{view,add,edit,delete}	all	\N
242	75	6	{view,add,edit,delete}	all	\N
244	79	6	{view,add,edit,delete}	all	\N
246	83	6	{view,add,edit,delete}	all	\N
247	84	6	{view,add,edit,delete}	all	\N
249	87	6	{view,add,edit,delete}	all	\N
250	89	6	{view,add,edit,delete}	all	\N
251	90	6	{view,add,edit,delete}	all	\N
253	1	6	{view}	all	\N
254	93	6	{view,add,edit,delete}	all	\N
261	110	6	{view,add,edit,delete}	all	\N
264	118	6	{view,add,edit,delete}	all	\N
267	121	6	{view}	all	\N
269	123	6	{view,close}	all	\N
271	146	6	{view,add,edit,delete}	all	\N
273	145	6	{view,add,edit,delete}	all	\N
274	144	6	{view,add,edit,delete}	all	\N
275	143	6	{view,add,edit,delete}	all	\N
276	142	6	{view,add,edit,delete}	all	\N
282	135	6	{view,add,edit,delete}	all	\N
277	141	6	{view}	all	\N
278	140	6	{view}	all	\N
279	139	6	{view}	all	\N
280	138	6	{view}	all	\N
281	137	6	{view,add,edit,delete}	structure	3
283	134	6	{view,add,edit,delete,calculation,invoice,contract}	structure	3
272	130	6	{view,add,edit,delete,order}	structure	3
270	126	6	{}	all	\N
284	124	6	{}	all	\N
266	120	6	{}	all	\N
265	119	6	{view,edit,delete}	all	\N
263	117	6	{view}	all	\N
262	111	6	{}	all	\N
260	107	6	{view}	all	\N
256	2	6	{}	all	\N
285	106	6	{}	all	\N
259	105	6	{}	all	\N
258	104	6	{view}	all	\N
286	103	6	{view,add,edit,delete}	all	\N
257	102	6	{view}	all	\N
255	101	6	{view}	all	\N
252	91	6	{view}	all	\N
248	86	6	{view}	all	\N
243	78	6	{view}	all	\N
229	65	6	{view}	all	\N
...
231	59	6	{}	all	\N
268	12	6	{}	all	\N
288	149	6	{view,add,edit,delete}	all	\N
290	152	6	{view,settings}	all	\N
291	153	6	{view}	all	\N
289	151	6	{view}	all	\N
287	148	6	{view}	all	\N
232	55	6	{view}	all	\N
245	47	6	{view}	all	\N
235	69	6	{view,add,edit,delete}	all	\N
\.


--
-- Name: permision_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--

SELECT pg_catalog.setval('permision_id_seq', 1, false);
...
COPY person (id, resource_id, person_category_id, first_name, last_name, second_name, birthday, gender, descr) FROM stdin;
19	1294	\N	Stas	Voevoda		2007-10-16	0	\N
24	1390	\N	Igor	Mazur		2007-07-21	0	\N
25	1408	\N	Vitalii	Klishunov		1976-04-07	0	\N
26	1409	\N	Natalia	Klishunova		1978-08-10	0	\N
27	1410	\N	Maxim	Klishunov		2005-02-16	0	\N
29	1465	\N	Eugen	Velichko		1982-04-07	0	\N
31	1472	\N	Velichko	Alexander		2006-01-11	0	\N
33	1586	\N	Roman	Babich		1990-11-14	0	\N
36	1616	\N	Nikolay	Artyuh		1986-10-08	0	\N
37	1619	\N	Andriy	Garkaviy		1984-11-14	0	\N
39	1627	\N	Petro	Garkaviy		2004-06-08	0	\N
41	1645	\N	Karpenko	Alexander		1990-06-04	0	\N
43	1869	\N	Alexey	Ivankiv	V.	\N	0	\N
38	1626	\N	Elena	Garkava		1986-01-08	0	\N
22	1383	\N	Vitalii	Mazur		1979-07-17	0	\N
44	2017	\N	Sergey	Gavrish		1981-08-05	0	\N
18	1293	\N	Irina	Voevoda		1984-01-18	1	\N
28	1411	\N	Ann	Klishunova		2013-02-14	1	\N
30	1471	\N	Irina	Avdeeva		1984-11-21	1	\N
32	1473	\N	Velichko	Elizabeth		2010-06-15	1	\N
34	1593	\N	Elena	Babich		1991-05-23	1	\N
42	1653	\N	Smichko	Olena		1992-07-15	1	\N
40	1628	\N	Alena	Garkava		2007-03-29	1	\N
35	1615	\N	Tat'ana	Artyuh		1987-02-10	1	\N
45	2020	\N	Anna	Gavrish		1993-11-17	1	\N
4	870	\N	Greg	Johnson		\N	0	\N
5	871	\N	John	Doe		\N	0	\N
46	2051	\N	Nikolay			\N	0	\N
23	1389	\N	Iren	Mazur		1979-09-03	1	\N
47	2090	\N	Jason		Lewis	\N	0	\N
48	2309	\N	Oleg			\N	0	\N
49	2314	\N	Anna			\N	1	\N
50	2328	\N	Alex	Nikitin		1991-08-14	0	\N
51	2339	\N	Julia	Nikitina		1991-12-12	1	\N
52	2340	\N	Ivan	Nikitin		2012-02-15	0	\N
53	2367	\N	Sergey	Stepanchuk		1984-11-06	0	\N
17	1284	\N	Nikolay	Voevoda		1981-07-22	0	\N
20	1372	1	Oleg	Pogorelov		1970-02-17	0	\N
21	1375	\N	Elena	Pogorelova	Petrovna	1972-02-19	1	\N
6	887	2	Peter	Parker		1976-04-07	0	\N
54	2376	2	Nadiya	Gavrilyuk		1988-03-02	1	\N
55	2560	3	Vladislav	Potusenko		\N	0	\N
57	2566	\N	Valik			\N	0	\N
58	2570	2	Jenya	Buryak		\N	1	\N
59	2573	3	Vlad	Petchenko		\N	0	\N
60	2576	\N	Olexiy	Spisovs'kiy		\N	0	\N
61	2580	\N	Vlad	Chernyavskiy		\N	0	\N
62	2591	3	Grigoriy	Yarmolenko		1972-10-19	0	\N
63	2593	3	Maria	Fed'ko		1993-05-19	1	\N
64	2595	\N	Irina			\N	1	\N
65	2660	3	Valentin	Gopko		\N	0	\N
66	2667	\N	Anatoliy	Fedirko		\N	0	\N
68	2679	\N	Yuriy	Fedirko		2012-04-05	0	\N
67	2678	\N	Anna	Fedirko		\N	1	\N
56	2563	3	Alex	Saveliev		\N	0	\N
69	2739	\N	Vitalii			\N	\N	\N
\.
...
SELECT pg_catalog.setval('person_category_id_seq', 1, false);
...
--
-- Name: position_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--
...
SELECT pg_catalog.setval('resource_log_id_seq', 1, false);
...
124	1954	emails_campaigns	Email Campaigns	EmailsCampaignsResource	travelcrm.resources.emails_campaigns	{"timeout": 12}	Emails Campaigns for subscribers	0
...
SELECT pg_catalog.setval('roomcat_id_seq', 1, false);
...
SELECT pg_catalog.setval('spassport_id_seq', 1, false);
...
2	858	\N	1	Kiev Office
3	859	2	1	Sales Department
4	860	32	1	Marketing Dep.
1	857	32	1	Software Dev. Dep.
5	861	32	1	CEO
7	1062	\N	1	Moscow Office
8	1250	\N	1	Odessa Office
9	1251	8	1	Sales Department
11	1277	\N	1	Lviv Office
32	725	\N	1	Head Office
13	1976	\N	1	Dnepropetrovsk Office
\.
...
--
-- Name: structure_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--

SELECT pg_catalog.setval('structure_id_seq', 1, false);
...
1	1865	4	Vitalii Mazur EUR | cash	0	\N
2	1866	2	News Travel | Bank	0	\N
3	1867	4	Alexander Karpenko | EUR	0	\N
4	1868	3	Garkaviy Andriy | UAH	0	\N
6	1875	3	Main Cash Account | rid: 1628	0	\N
8	1881	3	Main Cash Account | rid: 1372	0	\N
9	1888	2	Lun Real Estate | UAH	0	Month Rate
10	1902	3	Lun Real Estate | UAH | CASH	0	Lun on cash account
11	1911	4	Main Cash EUR Account | rid: 1465	0	\N
12	1913	2	Sun Marino Trvl | Cash UAH	0	Sun Marino Main Bank Subaccount
13	1991	3	Main Cash Account | rid: 1471	0	\N
14	1997	3	Main Cash Account | rid: 1645	0	\N
15	2002	3	Main Cash Account | rid: 1869	0	\N
16	2007	3	Main Cash Account | rid: 887	0	\N
17	2028	3	Main Cash Account | rid: 2017	0	\N
18	2438	4	COMPANY EUR CASH	0	Main company Eur cash subaccount
20	2440	2	COMPANY UAH BANK	0	Main Company Uah bank account subaccount
19	2439	3	COMPANY UAH CASH	0	Main company Uah cash subaccount
21	2442	3	Stepanchuk Sergey, UAH, cash	0	\N
22	2452	4	Oleg, EUR, cash	0	\N
23	2466	3	Tez Tour UAH, cash	0	Tez tour cash UAH subaccount
24	2738	2	Fedirko Anatoliy, UAH, bank	0	\N
\.
...
65	2216	1	New Wind	0	First touroperator
66	2223	2	MAU	0	Internation Ukrainian Airlines
68	2225	1	Four Winds	0	
69	2226	1	Akkord Tour	0	
86	2227	1	Feerija	0	
87	2228	1	TEZ Tour	0	
88	2229	1	Gamalija	0	
67	2224	1	News Travel	1	Cyprus touroperator only
89	2230	1	Voyage De Luxe	0	
90	2231	1	IdrisKa tour	0	
91	2232	1	Anex Tour	0	
92	2233	1	TUI	0	
93	2234	1	Turtess Travel	0	
94	2235	1	Coral Travel	0	
96	2237	1	Natali Turs	0	
97	2238	2	Kiy Avia	0	
98	2239	1	MIBS Travel	0	
99	2240	1	SAM	0	
100	2241	1	Pilot	0	
101	2242	1	Orbita	0	
95	2236	1	Pan Ukraine	1	
102	2272	3	Ukrainian Visa Center	0	Quick Visas in EU and helps to get visas in any other countries
\.
...
--
-- Name: supplier_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--
...
SELECT pg_catalog.setval('supplier_type_id_seq', 1, false);
...
37	1933	2	Call and remind about payment	2014-12-14 22:46:00+02	\N	\N	3
38	1934	2	Call and remind about payment	2014-12-12 22:50:00+02	\N	Call and remind to pay invoice	0
39	1935	2	Review Calculation	2014-12-12 22:52:00+02	\N	\N	0
40	1936	2	For testing Purpose only	2014-12-14 22:35:00+02	\N	\N	0
33	1922	30	Test	2014-12-07 21:36:00+02	\N	For testing purpose	1
55	2063	2	Revert status after testing	2015-03-08 19:41:00+02	\N	Set status into active after testing	0
56	2066	2	Notifications testing #2	2015-03-11 17:16:00+02	\N	\N	0
57	2068	2	Test Notification resource link	2015-03-11 19:28:00+02	\N	\N	0
48	1980	2	Check Reminder	2015-01-08 18:21:00+02	\N	Description to task	3
47	1971	2	Check Payments	2015-01-04 15:45:00+02	\N	\N	1
41	1939	2	I have the following code	2014-12-13 23:36:00+02	\N	\N	3
46	1964	2	For testing	2014-12-25 23:05:00+02	\N	For testing purpose only	3
45	1962	2	Test	2014-12-24 23:32:00+02	\N	\N	3
52	2009	2	I decided to try to follow the postgres approach as directly as possible and came up with the following migration.	2015-01-21 22:44:00+02	\N	\N	1
54	2062	2	New JEasyui version migrate	2015-03-07 21:43:00+02	\N	Migrate on new 0.4.2 jeasyui version, check all functionality.	2
44	1958	2	Test new scheduler realization	2014-12-22 19:18:00+02	\N	New scheduler realizations notifications test.	3
49	1982	2	The second task	2015-01-08 18:30:00+02	\N	Second test task	1
50	1983	2	Test	2015-01-13 17:06:00+02	\N	\N	1
51	1985	2	Test 2	2015-01-14 17:02:00+02	\N	\N	1
53	2016	2	Notify his	2015-02-02 17:09:00+02	\N	Notify about the documents	3
42	1940	2	Test notifications	2014-12-14 21:37:00+02	\N	\N	2
59	2131	2	Task For Lastovec	2015-04-23 15:32:00+03	\N	Test description for task	0
60	2171	2	Test for	2015-04-28 10:38:00+03	\N	\N	0
67	2197	2	Check reminder	2015-05-03 13:45:00+03	10	\N	0
68	2291	2	Call and ansswer about discount	2015-05-19 16:39:00+03	10	talk about discount	0
58	2075	2	Call about discounts	2015-03-21 17:20:00+02	10	Calls and talk about tour discounts	3
69	2303	2	Call about offer	2015-05-24 17:30:00+03	10	\N	0
70	2311	2	Select hotels and hot tours	2015-05-25 10:35:00+03	10	\N	0
71	2371	2	Call to client	2015-06-08 15:00:00+03	30	Call to client with success bucking	0
72	2381	2	Make an Invoice	2015-06-06 22:12:00+03	10	Make invoice for this order	0
73	2436	2	Позвонить клиент	2015-06-11 08:12:00+03	10	\N	0
35	1930	2	Check Person Details	2014-12-11 21:43:00+02	10	We'll reuse the Amount type from last week. It's mostly the same, except we'll remove __clause_element__(), and additionally provide a classmethod version of the as_currency() method, which we'll use when dealing with SQL expressions.	2
78	2584	2	JEasyui 1.4.3 migration	2015-07-20 00:05:00+03	10	Migrate to new version of JEasyui	0
36	1932	2	Call and remind about payments	2014-12-11 22:48:00+02	10	Bla-Bla	3
79	2671	2	Call to customer!	2015-07-22 12:05:00+03	10	call to customer and ask for offer	0
80	2730	2	Check invoice	2015-07-22 15:30:00+03	10	Check invoice sum and call about currencies rates	0
\.
...
SELECT pg_catalog.setval('ticket_class_id_seq', 1, false);
...
1	2145	15	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	MAU	2015-05-08	MAU	\N
2	2147	14	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
3	2149	15	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-25	\N	2015-04-30	\N	\N
4	2151	15	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
5	2153	15	1	14	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
6	2155	3	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
7	2157	15	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
8	2159	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
9	2161	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
10	2163	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
11	2165	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
12	2168	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
13	2173	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
14	2175	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
15	2177	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
16	2179	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
17	2181	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
18	2183	33	1	37	1	36	\N	\N	\N	\N	2	0	2015-04-30	\N	2015-05-08	\N	\N
19	2185	33	1	37	1	36	\N	15	30	\N	2	0	2015-04-30	\N	2015-05-08	\N	Description for service
20	2188	33	1	37	1	36	\N	15	30	\N	2	0	2015-04-30	\N	2015-05-08	\N	Description for service
21	2190	33	1	37	1	36	\N	15	30	\N	2	0	2015-04-30	\N	2015-05-08	\N	Description for service
22	2266	15	1	20	1	12	2	15	30	\N	2	0	2015-05-16	\N	2015-05-23	\N	\N
24	2286	15	1	31	1	32	12	16	26	\N	2	0	2015-05-20	\N	2015-05-27	\N	\N
23	2283	15	1	19	1	16	\N	\N	\N	\N	2	0	2015-05-22	\N	2015-05-29	\N	\N
26	2342	15	1	19	1	16	10	15	\N	\N	2	1	2015-07-13	#MAU	2015-07-18	#MAU	\N
27	2378	15	1	39	1	39	10	10	\N	\N	2	0	2015-06-28	#MAU	2015-07-04	#MAU	\N
25	2316	15	1	19	1	18	10	10	33	\N	2	0	2015-06-21	# MAU	2015-06-27	# MAU	\N
28	2687	14	1	40	1	40	10	3	\N	\N	2	1	2015-07-24	#MAU 127193	2015-07-30	#MAU 892134	\N
\.


--
-- Name: tour_id_seq; Type: SEQUENCE SET; Schema: company; Owner: mazvv
--
...
4	2517	YniVN8l0kTY.jpg	2015627/11fad20d-91e8-4aae-9991-84a9f3ce68a2.jpg	0.00	image/jpeg	
5	2518	YniVN8l0kTY.jpg	2015627/edbfabe1-5fa4-413f-a34a-7e87d2962dbd.jpg	0.00	image/jpeg	
7	2519	Che-Guevara-9322774-1-402.jpg	2015627/8c985058-a198-42df-97d2-f55996a1a9b3.jpg	0.00	image/jpeg	\N
8	2520	YniVN8l0kTY.jpg	2015627/cdef8ade-0166-4206-bac6-43f1a64ee471.jpg	0.00	image/jpeg	
9	2521	YniVN8l0kTY.jpg	2015627/e066c3a4-9840-434a-947d-088a46ecbb32.jpg	0.00	image/jpeg	
10	2522	YniVN8l0kTY.jpg	2015627/bacad34b-c04f-4a77-b8d1-3a1a5b944f5b.jpg	0.00	image/jpeg	
11	2523	Python..pdf	2015627/ba9d9b9e-220c-4ee7-b4d6-7e25a8582881.pdf	0.00	application/pdf	
12	2524	Python..pdf	2015627/64d46808-2e69-4048-bc60-ca7ee03de0de.pdf	0.00	application/pdf	
13	2525	Снимок экрана из 2015-06-18 13:18:52.png	2015627/5f588c0b-bd08-4f4e-a55e-54f76895a184.png	0.00	image/png	
14	2526	Снимок экрана из 2015-06-14 22:01:13.png	2015628/6b2d987b-b6fe-41d9-8edf-37b1e70fe79b.png	0.00	image/png	
15	2527	Снимок экрана из 2015-06-14 22:00:32.png	2015628/6e5fbc5e-7ee9-4abd-9329-2c365546a3cd.png	0.00	image/png	
16	2528	Снимок экрана из 2015-06-14 22:00:37.png	2015628/283deac4-aa2c-4222-a8c0-905d44de3530.png	0.00	image/png	
17	2664	the-perfect-client2.jpg	2015721/c0555abd-9463-4c6e-a938-c7319eeb7f6d.jpg	0.00	image/jpeg	Perfect client
18	2665	kabaeva_150.jpg	2015722/b32166eb-971c-4ce2-a05a-be76bed46579.jpg	0.00	image/jpeg	\N
19	2682	20120908105644_brooks.jpg	2015722/1ef77eb8-790f-4494-a9de-ae383a4b7142.jpg	0.00	image/jpeg	passport scan
20	2684	20120908105644_brooks.jpg	2015722/317847e8-f61f-404c-91b9-d6f03c8228dd.jpg	0.00	image/jpeg	
\.
...
23	894	7	maziv	maziv@mail.ru	111111
25	2054	30	maz_iv	maz_iv@travelcrm.org.ua	111111
31	2126	15	v.lastovec	lastovec@travelcrm.org.ua	111111
32	2484	31	alinka	kabaeva_alinka@mail.ru	111111
...
2	2542	4	5	2015-06-01	20.00	0	\N
3	2543	3	5	2015-05-01	20.00	0	\N
4	2544	3	4	2015-05-01	20.00	1	\N
5	2732	2	5	2015-08-01	20.00	1	\N
1	2515	2	5	2015-06-01	20.00	1	Vat on Tours is only for commission
6	2733	2	4	2015-07-01	20.00	1	\N
\.
...
SELECT pg_catalog.setval('vat_id_seq', 1, false);
...
SELECT pg_catalog.setval('_resources_logs_rid_seq', 7616, true);
...
SELECT pg_catalog.setval('_resources_rid_seq', 2739, true);
...
SELECT pg_catalog.setval('_resources_types_rid_seq', 153, true);
...
SELECT pg_catalog.setval('companies_counter', 1057, true);
...
COPY person (id, resource_id, first_name, last_name, second_name, birthday, gender, descr, person_category_id) FROM stdin;
19	1294	Stas	Voevoda		2007-10-16	0	\N	\N
24	1390	Igor	Mazur		2007-07-21	0	\N	\N
25	1408	Vitalii	Klishunov		1976-04-07	0	\N	\N
26	1409	Natalia	Klishunova		1978-08-10	0	\N	\N
27	1410	Maxim	Klishunov		2005-02-16	0	\N	\N
29	1465	Eugen	Velichko		1982-04-07	0	\N	\N
31	1472	Velichko	Alexander		2006-01-11	0	\N	\N
33	1586	Roman	Babich		1990-11-14	0	\N	\N
36	1616	Nikolay	Artyuh		1986-10-08	0	\N	\N
37	1619	Andriy	Garkaviy		1984-11-14	0	\N	\N
39	1627	Petro	Garkaviy		2004-06-08	0	\N	\N
41	1645	Karpenko	Alexander		1990-06-04	0	\N	\N
43	1869	Alexey	Ivankiv	V.	\N	0	\N	\N
38	1626	Elena	Garkava		1986-01-08	0	\N	\N
22	1383	Vitalii	Mazur		1979-07-17	0	\N	\N
44	2017	Sergey	Gavrish		1981-08-05	0	\N	\N
18	1293	Irina	Voevoda		1984-01-18	1	\N	\N
28	1411	Ann	Klishunova		2013-02-14	1	\N	\N
30	1471	Irina	Avdeeva		1984-11-21	1	\N	\N
32	1473	Velichko	Elizabeth		2010-06-15	1	\N	\N
34	1593	Elena	Babich		1991-05-23	1	\N	\N
42	1653	Smichko	Olena		1992-07-15	1	\N	\N
40	1628	Alena	Garkava		2007-03-29	1	\N	\N
35	1615	Tat'ana	Artyuh		1987-02-10	1	\N	\N
45	2020	Anna	Gavrish		1993-11-17	1	\N	\N
4	870	Greg	Johnson		\N	0	\N	\N
5	871	John	Doe		\N	0	\N	\N
46	2051	Nikolay			\N	0	\N	\N
23	1389	Iren	Mazur		1979-09-03	1	\N	\N
47	2090	Jason		Lewis	\N	0	\N	\N
48	2309	Oleg			\N	0	\N	\N
49	2314	Anna			\N	1	\N	\N
50	2328	Alex	Nikitin		1991-08-14	0	\N	\N
51	2339	Julia	Nikitina		1991-12-12	1	\N	\N
52	2340	Ivan	Nikitin		2012-02-15	0	\N	\N
53	2367	Sergey	Stepanchuk		1984-11-06	0	\N	\N
17	1284	Nikolay	Voevoda		1981-07-22	0	\N	\N
20	1372	Oleg	Pogorelov		1970-02-17	0	\N	1
21	1375	Elena	Pogorelova	Petrovna	1972-02-19	1	\N	\N
6	887	Peter	Parker		1976-04-07	0	\N	2
54	2376	Nadiya	Gavrilyuk		1988-03-02	1	\N	2
55	2560	Vladislav	Potusenko		\N	0	\N	3
57	2566	Valik			\N	0	\N	\N
58	2570	Jenya	Buryak		\N	1	\N	2
59	2573	Vlad	Petchenko		\N	0	\N	3
60	2576	Olexiy	Spisovs'kiy		\N	0	\N	\N
61	2580	Vlad	Chernyavskiy		\N	0	\N	\N
...
56	2563	Alex	Saveliev		\N	0	\N	3
69	2739	Vitalii			\N	\N	\N	\N
\.
...
--
-- Name: appointment_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: cashflow_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: contract_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: currency_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: email_campaign_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: employee_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: navigation_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: permision_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: position_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: region_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: resource_log_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: resource_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: resource_type_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: structure_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: supplier_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: tour_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: user_pkey; Type: CONSTRAINT; Schema: company; Owner: mazvv; Tablespace: 
--
...
--
-- Name: fk_currency_id_currency_rate; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_notification_id_employee_notification; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_resource_id_contract; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_resource_id_currency_rate; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_resource_id_email_campaign; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_resource_id_supplier; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_service_id_vat; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_subaccount_from_id_cashflow; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
--
-- Name: fk_subaccount_to_id_cashflow; Type: FK CONSTRAINT; Schema: company; Owner: mazvv
--
...
ALTER TABLE ONLY person
    ADD CONSTRAINT fk_person_category_id_person FOREIGN KEY (person_category_id) REFERENCES person_category(id);
