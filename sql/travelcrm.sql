...
--
-- Name: dismissal; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: dismissal_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE dismissal_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dismissal_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE dismissal_id_seq OWNED BY dismissal.id;
...
ALTER TABLE ONLY dismissal ALTER COLUMN id SET DEFAULT nextval('dismissal_id_seq'::regclass);
...
--
-- Data for Name: dismissal; Type: TABLE DATA; Schema: public; Owner: -
--

COPY dismissal (id, resource_id, date, employee_id) FROM stdin;
\.
...
COPY employee (id, resource_id, first_name, last_name, second_name, itn, photo_upload_id) FROM stdin;
4	786	Oleg	Pogorelov		\N	\N
8	893	Oleg	Mazur	V.	\N	\N
9	1040	Halyna	Sereda		\N	\N
10	1041	Andrey	Shabanov		\N	\N
11	1042	Dymitrii	Veremeychuk		\N	\N
13	1044	Alexandra	Koff	\N	\N	\N
14	1045	Dima	Shkreba	\N	\N	\N
15	1046	Viktoriia	Lastovets	\N	\N	\N
12	1043	Denis	Yurin	\N	12	\N
30	2053	Igor	Mazur	\N	\N	\N
31	2477	Alina	Kabaeva	\N	344	\N
2	784	John	Doe	\N	\N	\N
7	885	Irina	Mazur	V.	\N	\N
32	2785	Charlize	Theron	\N	\N	\N
\.
...
237	4	10	Dismissals	/dismissals	\N	3	2883	t	tab_open
8	4	\N	System	/	fa fa-cog	11	778	f	tab_open
239	4	238	Assign resources	/assigns/assign	\N	1	2889	f	dialog_open
238	4	\N	Tools	/	fa fa-gears	10	2888	f	tab_open
\.
...
39	69	4	{view,add,edit,delete,assign}	\N	all
42	71	4	{view,add,edit,delete,assign}	\N	all
43	72	4	{view,add,edit,delete,assign}	\N	all
44	73	4	{view,add,edit,delete,assign}	\N	all
45	74	4	{view,add,edit,delete,assign}	\N	all
46	75	4	{view,add,edit,delete,assign}	\N	all
49	79	4	{view,add,edit,delete,assign}	\N	all
55	83	4	{view,add,edit,delete,assign}	\N	all
56	84	4	{view,add,edit,delete,assign}	\N	all
58	86	4	{view,add,edit,delete,assign}	\N	all
61	89	4	{view,add,edit,delete}	\N	all
62	90	4	{view,add,edit,delete}	\N	all
70	101	4	{view,add,edit,delete}	\N	all
63	91	4	{view,add,edit,delete,assign}	\N	all
79	110	4	{view,add,edit,delete}	\N	all
71	102	4	{view,add,edit,delete,assign}	\N	all
73	104	4	{view,add,edit,delete,assign}	\N	all
74	105	4	{view,add,edit,delete,assign}	\N	all
76	107	4	{view,add,edit,delete,assign}	\N	all
26	47	4	{view,add,edit,delete,assign}	\N	all
80	111	4	{view,add,edit,delete,assign}	\N	all
128	117	4	{view,add,edit,delete,assign}	\N	all
59	87	4	{view,add,edit,delete}	\N	all
22	2	4	{view,add,edit,delete,assign}	\N	all
38	41	4	{view,add,edit,delete,assign}	\N	all
40	39	4	{view,add,edit,delete,assign}	\N	all
35	65	4	{view,add,edit,delete,assign}	\N	all
37	67	4	{view,add,edit,delete,assign}	\N	all
41	70	4	{view,add,edit,delete,assign}	\N	all
...
149	138	4	{view,add,edit,delete,assign}	\N	all
150	139	4	{view,add,edit,delete,assign}	\N	all
151	140	4	{view,add,edit,delete,assign}	\N	all
152	141	4	{view,add,edit,delete,assign}	\N	all
...
160	148	4	{view,add,edit,delete,assign}	\N	all
...
32	59	4	{view,add,edit,delete,assign}	\N	all
48	78	4	{view,add,edit,delete,assign}	\N	all
65	93	4	{view,add,edit,delete,assign}	\N	all
72	103	4	{view,add,edit,delete,assign,settings}	\N	all
131	120	4	{view,add,edit,delete,assign}	\N	all
153	142	4	{view,add,edit,delete,assign}	\N	all
294	156	4	{view,add,edit,delete,settings,assign}	\N	all
30	55	4	{view,add,edit,delete,assign}	\N	all
297	159	4	{view,add,edit,delete,assign}	\N	all
298	160	4	{assign}	\N	all
\.
...
SELECT pg_catalog.setval('positions_navigations_id_seq', 239, true);
...
SELECT pg_catalog.setval('positions_permisions_id_seq', 298, true);
...
SELECT pg_catalog.setval('resource_type_id_seq', 160, true);
...
--
-- Name: dismissal_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY dismissal
    ADD CONSTRAINT dismissal_pkey PRIMARY KEY (id);
...
--
-- Name: fk_maintainer_id_resource; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY resource
    ADD CONSTRAINT fk_maintainer_id_resource FOREIGN KEY (maintainer_id) REFERENCES employee(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: fk_resource_id_dismissal; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dismissal
    ADD CONSTRAINT fk_resource_id_dismissal FOREIGN KEY (resource_id) REFERENCES resource(id) ON UPDATE CASCADE ON DELETE RESTRICT;
