...
from ..lib.qb.structure import StructureQueryBuilder
from ..lib.utils.common_utils import translate as _
from ..lib.utils.security_utils import get_auth_employee
from ..forms.structure import StructureSchema
...
@view_defaults(
    context='..resources.structure.StructureResource',
)
class StructureView(object):
    ...
    def list(self):
        ...
        qb = StructureQueryBuilder(self.context)
        qb.filter_parent_id(
            parent_id,
