...
from ..lib.qb.sales_dynamics import SalesDynamicsQueryBuilder
from ..forms.sales_dynamics import (
    SettingsSchema, 
    SalesDynamicsSchema
)
...
@view_defaults(
    context='..resources.sales_dynamics.SalesDynamicsResource',
)
class SalesDynamicsView(object):
    ...
    @view_config(
        request_method='GET',
        renderer='travelcrm:templates/sales_dynamics/index.mako',
        permission='view'
    )
    def index(self):
        return {}
    ...
    @view_config(
        name='settings',
        request_method='GET',
        renderer='travelcrm:templates/sales_dynamics/settings.mako',
        permission='settings',
    )
    def settings(self):
