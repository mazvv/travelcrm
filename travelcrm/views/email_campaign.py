...
from ..lib.qb.email_campaign import EmailCampaignQueryBuilder
...
from ..forms.email_campaign import (
    EmailCampaignSchema,
...
@view_defaults(
    context='..resources.email_campaign.EmailCampaignResource',
)
class EmailCampaignView(object):
    ...
    def list(self):
        ...
        qb = EmailCampaignQueryBuilder(self.context)
