...
from travelcrm.models.wish_item import WishItem
from ..lib.qb.wishes_items import WishesItemsQueryBuilder
from ..lib.utils.common_utils import translate as _

from travelcrm.forms.wishes_items import WishItemSchema


log = logging.getLogger(__name__)


class WishItems(object):
    ...
    @view_config(
        context='..resources.wishes_items.WishesItems',
        request_method='GET',
    ...
    def _list(self):
        qb = WishesItemsQueryBuilder(self.context)
        qb.search_simple(
    ...
    def view(self):
        if self.request.params.get('rid'):
            ...
            wish_item = WishItem.by_resource_id(resource_id)
            return HTTPFound(
