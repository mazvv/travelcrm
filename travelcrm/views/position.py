...
from ..lib.qb.position import PositionQueryBuilder
from ..lib.utils.common_utils import translate as _

from ..forms.position import (
    PositionSchema,
...
@view_defaults(
    context='..resources.position.PositionResource',
)
class PositionView(object):
    ...
    def list(self):
        ...
        qb = PositionQueryBuilder(self.context)
