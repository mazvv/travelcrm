...
@view_defaults(
    context='..resources.hotelcats.HotelcatsResource',
)
class HotelcatsView(BaseView):

    @view_config(
        request_method='GET',
        renderer='travelcrm:templates/hotelcats/index.mako',
        permission='view'
    )
    def index(self):
        return {
    ...
    @view_config(
        name='view',
        request_method='GET',
        renderer='travelcrm:templates/hotelcats/form.mako',
        permission='view'
    )
    def view(self):
    ...
    def copy(self):
        hotelcat = Hotelcat.get_copy(self.request.params.get('id'))
        return {
    ...
    @view_config(
        name='delete',
        request_method='GET',
        renderer='travelcrm:templates/hotelcats/delete.mako',
        permission='delete'
    )
    def delete(self):
        return {
    ...
    def _delete(self):
        ...
        if ids:
            try:
                items = DBSession.query(Hotelcat).filter(
                    Hotelcat.id.in_(ids)
                )
                for item in items:
    ...
    @view_config(
        name='assign',
        request_method='GET',
        renderer='travelcrm:templates/hotelcats/assign.mako',
        permission='assign'
    )
    def assign(self):
        return {
    ...
    def _assign(self):
        form = HotelcatAssignForm(self.request)
        if form.validate():
    ...
    @view_config(
        name='subscribe',
        request_method='GET',
        renderer='travelcrm:templates/hotelcats/subscribe.mako',
        permission='view'
    )
    def subscribe(self):
        return {
    ...
    def _subscribe(self):
        ...
        for id in ids:
            ...
            subscribe_resource(self.request, hotelcat.resource)
        return {
