...
@view_defaults(
    context='..resources.roomcat.RoomcatResource',
)
class RoomcatView(object):
    ...
    @view_config(
        request_method='GET',
        renderer='travelcrm:templates/roomcat/index.mak',
        permission='view'
    )
    def index(self):
        return {}
    ...
    @view_config(
        name='view',
        request_method='GET',
        renderer='travelcrm:templates/roomcat/form.mak',
        permission='view'
    )
    def view(self):
    ...
    @view_config(
        name='delete',
        request_method='GET',
        renderer='travelcrm:templates/roomcat/delete.mak',
        permission='delete'
    )
    def delete(self):
        return {
