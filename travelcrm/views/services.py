...
@view_defaults(
    context='..resources.services.ServicesResource',
)
class ServicesView(BaseView):

    @view_config(
        request_method='GET',
        renderer='travelcrm:templates/services/index.mako',
        permission='view'
    )
    def index(self):
        return {
    ...
    def list(self):
        form = ServiceSearchForm(self.request, self.context)
        form.validate()
        qb = form.submit()
        return {
            'total': qb.get_count(),
    ...
    @view_config(
        name='view',
        request_method='GET',
        renderer='travelcrm:templates/services/form.mako',
        permission='view'
    )
    def view(self):
    ...
    def copy(self):
        service = Service.get_copy(self.request.params.get('id'))
        return {
    ...
    @view_config(
        name='delete',
        request_method='GET',
        renderer='travelcrm:templates/services/delete.mako',
        permission='delete'
    )
    def delete(self):
        return {
    ...
    @view_config(
        name='assign',
        request_method='GET',
        renderer='travelcrm:templates/services/assign.mako',
        permission='assign'
    )
    def assign(self):
        return {
    ...
    def _assign(self):
        form = ServiceAssignForm(self.request)
        if form.validate():
    ...
    @view_config(
        name='subscribe',
        request_method='GET',
        renderer='travelcrm:templates/services/subscribe.mako',
        permission='view'
    )
    def subscribe(self):
        return {
    ...
    def _subscribe(self):
        ...
        for id in ids:
            ...
            subscribe_resource(self.request, service.resource)
        return {
