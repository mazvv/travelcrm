...
class SuppliersTypesView(object):
    ...
    def add(self):
        return {'title': _(u'Add Supplier Type')}
    ...
    def edit(self):
        ...
        return {'item': supplier_type, 'title': _(u'Edit Hotel Category')}
    ...
    def delete(self):
        return {
            'title': _(u'Delete Supplier Types'),
    ...
    def _delete(self):
        ...
        if ids:
            try:
                (
                    DBSession.query(SupplierType)
                    .filter(SupplierType.id.in_(ids))
                    .delete()
                )
            except:
                DBSession.rollback()
