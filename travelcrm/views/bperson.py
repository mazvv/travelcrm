...
@view_defaults(
    context='..resources.bperson.BPersonResource',
)
class BPersonView(object):
    ...
    @view_config(
        request_method='GET',
        renderer='travelcrm:templates/bperson/index.mak',
        permission='view'
    )
    def index(self):
        return {}
    ...
    @view_config(
        name='view',
        request_method='GET',
        renderer='travelcrm:templates/bperson/form.mak',
        permission='view'
    )
    def view(self):
    ...
    @view_config(
        name='details',
        request_method='GET',
        renderer='travelcrm:templates/bperson/details.mak',
        permission='view'
    )
    def details(self):
        bperson = BPerson.get(self.request.params.get('id'))
    ...
    @view_config(
        name='delete',
        request_method='GET',
        renderer='travelcrm:templates/bperson/delete.mak',
        permission='delete'
    )
    def delete(self):
        return {
