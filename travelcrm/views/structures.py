...
class StructuresView(BaseView):
    ...
    @view_config(
        name='assign',
        request_method='GET',
        renderer='travelcrm:templates/structures/assign.mako',
        permission='assign'
    )
    def assign(self):
        return {
    ...
    def _assign(self):
        form = StructureAssignForm(self.request)
        if form.validate():
    ...
    @view_config(
        name='subscribe',
        request_method='GET',
        renderer='travelcrm:templates/structures/subscribe.mako',
        permission='view'
    )
    def subscribe(self):
        return {
    ...
    def _subscribe(self):
        ...
        for id in ids:
            ...
            subscribe_resource(self.request, structure.resource)
        return {
