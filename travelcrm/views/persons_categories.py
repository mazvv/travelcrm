...
class PersonsCategoriesView(BaseView):
    ...
    def _add(self):
        ...
        if form.validate():
            ...
            DBSession.flush()
            event = ResourceCreated(self.request, person_category)
            event.registry()
            return {
    ...
    def _edit(self):
        ...
        if form.validate():
            ...
            event = ResourceChanged(self.request, person_category)
            event.registry()
            return {
                'success_message': _(u'Saved'),
                'response': person_category.id
    ...
    @view_config(
        name='assign',
        request_method='GET',
        renderer='travelcrm:templates/persons_categories/assign.mako',
        permission='assign'
    )
    def assign(self):
        return {
    ...
    def _assign(self):
        form = PersonCategoryAssignForm(self.request)
        if form.validate():
    ...
    @view_config(
        name='subscribe',
        request_method='GET',
        renderer='travelcrm:templates/persons_categories/subscribe.mako',
        permission='view'
    )
    def subscribe(self):
        return {
    ...
    def _subscribe(self):
        ...
        for id in ids:
            ...
            subscribe_resource(self.request, person_category.resource)
        return {
