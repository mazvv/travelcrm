...
from ..lib.qb.lead import LeadQueryBuilder
from ..lib.utils.common_utils import translate as _

from ..forms.lead import (
    LeadSchema, 
    LeadSearchSchema
)
...
@view_defaults(
    context='..resources.lead.LeadResource',
)
class LeadView(object):
    ...
    def list(self):
        ...
        qb = LeadQueryBuilder(self.context)
