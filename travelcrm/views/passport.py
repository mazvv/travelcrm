...
from ..lib.qb.passport import PassportQueryBuilder
from ..lib.utils.common_utils import translate as _

from ..forms.passport import PassportSchema
...
@view_defaults(
    context='..resources.passport.PassportResource',
)
class PassportView(object):
    ...
    def _list(self):
        qb = PassportQueryBuilder(self.context)
        qb.search_simple(
