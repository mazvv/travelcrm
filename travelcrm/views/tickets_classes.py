...
class TicketsClassesView(object):
    ...
    def add(self):
        return {'title': _(u'Add TicketClass')}
    ...
    def edit(self):
        ...
        return {'item': ticket_class, 'title': _(u'Edit TicketClass')}
