...
class TicketsClassesView(BaseView):
    ...
    def copy(self):
        ticket_class = TicketClass.get_copy(self.request.params.get('id'))
        return {
    ...
    @view_config(
        name='assign',
        request_method='GET',
        renderer='travelcrm:templates/tickets_classes/assign.mako',
        permission='assign'
    )
    def assign(self):
        return {
    ...
    def _assign(self):
        form = TicketClassAssignForm(self.request)
        if form.validate():
    ...
    @view_config(
        name='subscribe',
        request_method='GET',
        renderer='travelcrm:templates/tickets_classes/subscribe.mako',
        permission='view'
    )
    def subscribe(self):
        return {
    ...
    def _subscribe(self):
        ...
        for id in ids:
            ...
            subscribe_resource(self.request, ticket_class.resource)
        return {
