...
from ..lib.qb.navigation import NavigationQueryBuilder
from ..lib.bl.navigations import (
    get_next_position,
    copy_from_position,
)
from ..lib.utils.common_utils import translate as _
from ..forms.navigation import (
    NavigationSchema,
...
@view_defaults(
    context='..resources.navigation.NavigationResource',
)
class NavigationView(object):
    ...
    def list(self):
        ...
        qb = NavigationQueryBuilder(self.context)
