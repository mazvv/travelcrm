...
class CurrenciesView(BaseView):
    ...
    def copy(self):
        currency = Currency.get_copy(self.request.params.get('id'))
        return {
    ...
    @view_config(
        name='assign',
        request_method='GET',
        renderer='travelcrm:templates/currencies/assign.mako',
        permission='assign'
    )
    def assign(self):
        return {
    ...
    def _assign(self):
        form = CurrencyAssignForm(self.request)
        if form.validate():
    ...
    @view_config(
        name='subscribe',
        request_method='GET',
        renderer='travelcrm:templates/currencies/subscribe.mako',
        permission='view'
    )
    def subscribe(self):
        return {
    ...
    def _subscribe(self):
        ...
        for id in ids:
            ...
            subscribe_resource(self.request, currency.resource)
        return {
