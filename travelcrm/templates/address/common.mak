<%def name="address_selector(name='address_id', values=[], can_edit=True)">
    <%
        ...
        <div class="actions button-container">
            ...
            <div class="button-group minor-group">
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/address/add'
                    ">
                    ${_(u"Add")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/address/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
