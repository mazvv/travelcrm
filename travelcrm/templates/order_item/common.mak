<%def name="order_item_selector(name='order_item_id', values=[], can_edit=True)">
    ...
    <table class="easyui-datagrid"
        ...
        <thead>
            ...
            <th data-options="field:'supplier',sortable:true,width:100">${_(u"supplier")}</th>
        ...
        <div class="actions button-container dl45">
            ...
            <div class="button-group minor-group ml1">
                ...
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/order_item/copy',property:'with_row'
                    ">
                    ${_(u"Copy")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/order_item/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
