...
<div class="easyui-panel unselectable"
    ...
    <table class="easyui-datagrid"
        ...
        <thead>
            ...
            <th data-options="field:'supplier',sortable:true,width:140">${_(u"supplier")}</th>
    ...
    <div class="datagrid-toolbar" id="${_tb_id}">
        ...
        <div class="ml50 tr">
            <div class="search">
                ${searchbar(_id, _s_id, prompt=_(u'Enter contract num'))}
                <div class="advanced-search tl hidden" id = "${_s_id}">
                    ...
                    <div>
                        ${h.fields.suppliers_combogrid_field(
                            request, 'supplier_id', show_toolbar=False
                        )}
                    </div>
                    <div class="mt05">
