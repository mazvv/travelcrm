<%def name="contract_selector(name='contract_id', values=[], can_edit=True)">
    <%
    ...
    <table class="easyui-datagrid"
        id="${_id}"
        data-options="
            url:'/contract/list',border:false,
        ...
        <thead>
            ...
            <th data-options="field:'num',sortable:true,width:140">${_(u"contract num")}</th>
        ...
        <div class="actions button-container">
            <div class="button-group minor-group">
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/contract/add'
                    ">
                    ${_(u"Add")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/contract/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
