<%def name="commission_selector(name='commission_id', values=[], can_edit=True)">
    ...
    <table class="easyui-datagrid"
        id="${_id}"
        data-options="
            url:'/commission/list',border:false,
        ...
        <div class="actions button-container">
            <div class="button-group minor-group">
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/commission/add'
                    ">
                    ${_(u"Add")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/commission/copy',property:'with_row'
                    ">
                    ${_(u"Copy")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/commission/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
