<%def name="services_selector(name='service_id', values=[], can_edit=True)">
    <%
    ...
    <table class="easyui-datagrid"
        id="${_id}"
        data-options="
            url:'/services/list',border:false,
            singleSelect:true,
    ...
    <div class="datagrid-toolbar" id="${_tb_id}">
        <div class="actions button-container dl45">
            ...
            <div class="button-group minor-group ml1">
                ...
                % if 'edit' in h.permisions.get_services_permisions(request):
                <a href="#" class="button easyui-linkbutton _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/services/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
                % endif
