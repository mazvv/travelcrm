...
<div class="easyui-panel unselectable"
    ...
    <table class="easyui-datagrid"
        ...
        <thead>
            ...
            <th data-options="field:'account_item',sortable:true,width:200">${_(u"account item")}</th>
            <th data-options="field:'resource_type',sortable:true,width:150">${_(u"resource type")}</th>
    ...
    <div class="datagrid-toolbar" id="${_tb_id}">
        ...
        <div class="ml45 tr">
            <div class="search">
                ${searchbar(_id, _s_id, prompt=_(u'Enter service name'))}
