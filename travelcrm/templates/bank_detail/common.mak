<%def name="bank_detail_selector(name='bank_detail_id', values=[], can_edit=True)">
    ...
    <table class="easyui-datagrid"
        id="${_id}"
        data-options="
            url:'/bank_detail/list',border:false,
        ...
        <div class="actions button-container">
            <div class="button-group minor-group">
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/bank_detail/add'
                    ">
                    ${_(u"Add")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/bank_detail/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
