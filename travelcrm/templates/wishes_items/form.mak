    ...
    ${h.tags.form(request.url, class_="_ajax %s" % ('readonly' if readonly else ''), autocomplete="off")}
        <div title="${_(u'Main')}">
            ...
            <div class="form-field">
                ...
                <div class="ml15">
                    ${h.tags.text('price_from', item.price_from if item else None, class_="easyui-textbox w20 easyui-numberbox", data_options="min:0,precision:2")}
            ...
            <div class="form-field">
                ...
                <div class="ml15">
                    ${h.tags.text('price_to', item.price_to if item else None, class_="easyui-textbox w20 easyui-numberbox", data_options="min:0,precision:2")}
