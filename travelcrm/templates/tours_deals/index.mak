...
<div class="easyui-panel unselectable"
    ...
    <table class="easyui-datagrid"
        ...
        <thead>
            ...
            <th data-options="field:'locations',sortable:true,width:200">${_(u"locations")}</th>
            <th data-options="field:'hotels',sortable:true,width:200">${_(u"hotels")}</th>
