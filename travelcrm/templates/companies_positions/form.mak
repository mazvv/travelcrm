<div class="dl40 easyui-dialog"
    ...
    ">
    ${h.tags.form(request.url, class_="_ajax", autocomplete="off", hidden_fields=[('companies_id', company.id),])}
        ...
        <div class="form-field">
            ...
            <div class="ml15">
                ${h.fields.company_structures_combotree_field(company.id, item.structure_id if item else None, 'structure_id')}
            </div>
        </div>
        <div class="form-field">
            <div class="dl15">
