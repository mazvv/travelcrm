    ...
    ${h.tags.form(
        ...
        <div class="easyui-tabs" data-options="border:false,height:400">
            <div title="${_(u'Main')}">
                ...
                <div class="form-field">
                    <div class="dl15">
                        ${h.tags.title(_(u"parent account item"), False, "parent_id")}
                    </div>
                    <div class="ml15">
                        ${h.fields.accounts_items_combotree_field('parent_id', item.parent_id if item else None)}
                        ${h.common.error_container(name='parent_id')}
                    </div>
                </div>
                <div class="form-field">
                    <div class="dl15">
                        ${h.tags.title(_(u"type"), True, "type")}
                    </div>
                    <div class="ml15">
                        ${h.fields.accounts_items_types_combobox_field(
                            'type',
                            item.type.key if item else None
                        )}
                        ${h.common.error_container(name='type')}
                    </div>
                </div>
                <div class="form-field">
                    <div class="dl15">
                    ...
                    <div class="ml15">
                        ${h.fields.accounts_items_statuses_combobox_field(
                            'status',
