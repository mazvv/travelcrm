<%def name="task_selector(name='task_id', values=[], can_edit=True)">
    <%
    ...
    <table class="easyui-datagrid"
        ...
        <thead>
            ...
            <th data-options="field:'title',sortable:true,width:300">${_(u"title")}</th>
        ...
        <div class="actions button-container">
            ...
            <div class="button-group minor-group">
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/task/add'
                    ">
                    ${_(u"Add")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/task/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
