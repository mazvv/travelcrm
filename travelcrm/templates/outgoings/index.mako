...
<div class="easyui-panel unselectable"
    ...
    <table class="easyui-datagrid"
        ...
        <thead>
            ...
            <th data-options="field:'resource_type',sortable:true,width:90">${_(u"resource type")}</th>
            <th data-options="field:'account',sortable:true,width:150">${_(u"account")}</th>
            <th data-options="field:'sum',sortable:true,width:80">${_(u"sum")}</th>
                ...
                <div class="advanced-search tl hidden" id = "${_s_id}">
                    ...
                    <div>
                        ${h.fields.accounts_combogrid_field(
                            request, 'account_id', show_toolbar=False
                        )}
                    </div>
                    <div class="mt05">
                    ...
                    <div>
                        ${h.fields.date_field('payment_from')}
                        <span class="p1">-</span>
                        ${h.fields.date_field('payment_to')}
                    </div>
                    <div class="mt05">
