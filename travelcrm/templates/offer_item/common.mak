<%def name="offers_items_selector(name='offer_item_id', values=[], can_edit=True)">
    <%
    ...
    <table class="easyui-datagrid"
        id="${_id}"
        data-options="
            url:'/offers_items/list',border:false,
            singleSelect:true,
            ...
            onExpandRow: function(index, row){
                ...
                $('#' + row_id).load(
                    '/offers_items/details?id=' + row.id, 
                    function(){
        ...
        <div class="actions button-container dl20">
            <div class="button-group minor-group">
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/offers_items/add'
                    ">
                    ${_(u"Add")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/offers_items/copy',property:'with_row'
                    ">
                    ${_(u"Copy")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/offers_items/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
