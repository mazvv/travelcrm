...
<div class="easyui-panel unselectable"
    ...
    <table class="easyui-datagrid"
        ...
        <thead>
            ...
            <th data-options="field:'location_name',sortable:true,width:200">${_(u"location")}</th>
            <th data-options="field:'region_name',sortable:true,width:200,formatter:function(value,row){return value + ' (' + row.country_name + ')'}">${_(u"region")}</th>
    ...
    <div class="datagrid-toolbar" id="${_tb_id}">
        ...
        <div class="ml50 tr">
            <div class="search">
                ${searchbar(_id, _s_id, prompt=_(u'Enter location, region or country name'))}
