<%def name="liabilities_items_selector(name='liability_item_id', values=[], can_edit=True, resource_id=None)">
    <%
    ...
    <table class="easyui-datagrid"
        id="${_id}"
        data-options="
            url:'/liabilities_items/list',border:false,
            singleSelect:true,
    ...
    <div class="datagrid-toolbar" id="${_tb_id}">
        <div class="actions button-container dl30">
            <div class="button-group minor-group">
                % if resource_id:
                <a href="#" class="button _action"
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/liabilities_items/autoload?resource_id=${resource_id}'
                    ">
                    ${_(u"Autoload")}</a>
                % else:
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/liabilities_items/add'
                    ">
                    ${_(u"Add")}</a>
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/liabilities_items/copy',property:'with_row'
                    ">
                    ${_(u"Copy")}</a>
                % endif
                <a href="#" class="button _action" 
                    data-options="
                        container:'#${_id}',action:'dialog_open',url:'/liabilities_items/edit',property:'with_row'
                    ">
                    ${_(u"Edit")}</a>
                <a href="#" class="button danger" onclick="delete_${_func_id}('${_id}');">${_(u"Delete")}</a>
            </div>
        </div>
        <div class="ml30 tr" style="padding-top:5px;">
