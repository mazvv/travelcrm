...
class TourSaleQueryBuilder(ResourcesQueryBuilder):

    def __init__(self, context):
        super(TourSaleQueryBuilder, self).__init__(context)
        self._subq_points = (
            DBSession.query(
        ...
        self._subq_calculations = (
            ...
            .filter(Calculation.service_item_id == ServiceItem.id)
            .exists()
        )
        self._fields = {
            'id': TourSale.id,
            ...
            'hotel_cat': self._subq_points.c.hotel_cat,
            'country': self._subq_points.c.country,
    ...
    def build_query(self):
        ...
        super(TourSaleQueryBuilder, self).build_query()
    ...
    def advanced_search(self, **kwargs):
        super(TourSaleQueryBuilder, self).advanced_search(**kwargs)
...
class TourSalePointQueryBuilder(GeneralQueryBuilder):
    ...
    def build_query(self):
        ...
        super(TourSalePointQueryBuilder, self).build_query()
