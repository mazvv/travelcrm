...
class SubaccountQueryBuilder(ResourcesQueryBuilder):

    def __init__(self, context):
        super(SubaccountQueryBuilder, self).__init__(context)
    ...
    def build_query(self):
        ...
        super(SubaccountQueryBuilder, self).build_query()
    ...
    def advanced_search(self, **kwargs):
        super(SubaccountQueryBuilder, self).advanced_search(**kwargs)
