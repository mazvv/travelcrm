...
class OutgoingQueryBuilder(ResourcesQueryBuilder):

    def __init__(self, context):
        super(OutgoingQueryBuilder, self).__init__(context)
    ...
    def build_query(self):
        ...
        super(OutgoingQueryBuilder, self).build_query()
    ...
    def advanced_search(self, **kwargs):
        super(OutgoingQueryBuilder, self).advanced_search(**kwargs)
