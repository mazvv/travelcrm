...
class TouroperatorQueryBuilder(ResourcesQueryBuilder):

    def __init__(self, context):
        super(TouroperatorQueryBuilder, self).__init__(context)
        self._fields = {
            'id': Touroperator.id,
            '_id': Touroperator.id,
    ...
    def build_query(self):
        ...
        super(TouroperatorQueryBuilder, self).build_query()
