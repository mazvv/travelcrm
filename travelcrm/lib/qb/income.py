...
class IncomeQueryBuilder(ResourcesQueryBuilder):

    def __init__(self, context):
        super(IncomeQueryBuilder, self).__init__(context)
        ...
        self._sum_subq = (
            ...
            .group_by(Income.id, Cashflow.date)
            .subquery()
        )
        self._fields = {
            'id': Income.id,
    ...
    def build_query(self):
        ...
        super(IncomeQueryBuilder, self).build_query()
    ...
    def advanced_search(self, **kwargs):
        super(IncomeQueryBuilder, self).advanced_search(**kwargs)
